...
"""
UNI_SCID 91310000607212368N
REG_NO 310000400019913
ENT_NAME 上海国兴金属制品有限公司
ENT_TYPE 02
EST_DATE 1992-08-19
LEREP 吴修哲
REG_CAP 960
DOM 上海市青浦区华新镇北青公路3888号
OP_SCOPE 生产各种汽车、摩托车用的铝合金轮圈；生产再生铝锭、铝铸件及其他金属制品；模具、污染防治设备及废（污）水处理设备的加工，销售公司自产产品。
【依法须经批准的项目，经相关部门批准后方可开展经营活动】
OP_FROM 1992-08-19
OP_TO 2040-08-18
REG_ORGAN_NAME None
APPR_DATE 1992-08-19
REG_STATE 存续（在营、开业、在册）
REV_DATE None
ENT_UUID 000000021992081929021
NEIGHBOR 华新镇
INDUSTRY_CODE 3650
"""

class Enterprise(models.Model):
    ENT_NAME = models.CharField('企业名称', max_length = 200)
    DOM = models.CharField('经营地址', max_length = 500, blank = True)
    REG_NO = models.CharField('企业注册号', max_length = 100, blank = True)
    UNI_SCID = models.CharField('统一社会信用代码', max_length = 100, blank = True)
    NEIGHBOR = models.CharField('街道', max_length = 100, blank = True)
...
class TTaskinfo(models.Model):
    ...
    taskid = models.CharField( max_length=20, verbose_name = '任务号')
    casesn = models.CharField(max_length=100, blank=True, null=True)
    infosourceid = models.FloatField()
    discovertime = models.DateTimeField(blank=True, null=True, verbose_name= '发现时间')
    percreatetime = models.DateTimeField(blank=True, null=True)
    createtime = models.DateTimeField(blank=True, null=True)
    dispatchtime = models.DateTimeField(blank=True, null=True)
    solvingtime = models.DateTimeField(blank=True, null=True)
    stime = models.DateTimeField(blank=True, null=True)
    supervisetime = models.DateTimeField(blank=True, null=True)
    delaytime = models.DateTimeField(blank=True, null=True)
    deptbacktime = models.DateTimeField(blank=True, null=True)
    checkdelaytime = models.DateTimeField(blank=True, null=True)
    checkdeptbacktime = models.DateTimeField(blank=True, null=True)
    xiafaheshitime = models.DateTimeField(blank=True, null=True)
    shangbaoheshitime = models.DateTimeField(blank=True, null=True)
    xiafahechatime = models.DateTimeField(blank=True, null=True)
    shangbaohechatime = models.DateTimeField(blank=True, null=True)
    telasktime = models.DateTimeField(blank=True, null=True)
    ...
    address = models.CharField(max_length=1000, blank=True, null=True, verbose_name = '地址')
    ...
    description = models.CharField(max_length=2000, blank=True, null=True, verbose_name = '备注')
    ...
    allmiddletime = models.DateTimeField(blank=True, null=True)
    allimportanttime = models.DateTimeField(blank=True, null=True)
    allendtime = models.DateTimeField(blank=True, null=True)
    middlesolvingtime = models.DateTimeField(blank=True, null=True)
    importantsolvingtime = models.DateTimeField(blank=True, null=True)
    lastsolvingtime = models.DateTimeField(blank=True, null=True)
    lastarrivetime = models.DateTimeField(blank=True, null=True)
    ...
    firstcontacttime = models.DateTimeField(blank=True, null=True)
    cancletime = models.DateTimeField(blank=True, null=True)
    ...
    lastcontacttime = models.DateTimeField(blank=True, null=True)
    ...
    deptname = models.CharField(max_length=100, blank=True, null=True, verbose_name = '主责部门')
    ...
    lasttakecasetime = models.DateTimeField(blank=True, null=True)
    ...
    feedbacktime_12345 = models.DateTimeField(blank=True, null=True)
    ...
    qpdispatchtime = models.DateTimeField(blank=True, null=True)
    qpsolvingtime = models.DateTimeField(blank=True, null=True)
    expsatisfaction = models.FloatField(blank=True, null=True)
    expsatisfactiontime = models.DateTimeField(blank=True, null=True)
    ...
    replytime_sl = models.DateTimeField(blank=True, null=True)
    ...
    middispatchtime = models.DateTimeField(blank=True, null=True)
    qplastsolvingtime = models.DateTimeField(blank=True, null=True)
    ...
    firstdispatchtime = models.DateTimeField(blank=True, null=True)
    ...
    enterpriseinvoledname = models.CharField(max_length=100, blank=True, null=True, verbose_name = '企业关键字')
