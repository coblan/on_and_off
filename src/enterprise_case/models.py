...
class Enterprise(models.Model):
    ...
    DOM = models.CharField('经营地址', max_length = 500)
    REG_NO = models.CharField('企业注册号', max_length = 100)
    UNI_SCID = models.CharField('统一社会信用代码', max_length = 100)
    NEIGHBOR = models.CharField('街道', max_length = 100)
...
class TTaskinfo(models.Model):
    ...
    discovertime = models.DateField(blank=True, null=True, verbose_name= '发现时间')
